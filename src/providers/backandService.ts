...
import {Observable, Subject} from 'rxjs';//import {Observable, BehaviorSubject, Subject} from 'rxjs'; //Remmed 20161126 due to linting errors
import {Http, Headers} from '@angular/http';//import {Http, Headers, URLSearchParams} from '@angular/http'; //Remmed 20161126 due to linting errors
...
export class BackandService {
    ...
    //private is_auth_error:boolean = false; //Remmed 20161126 due to linting errors
   ...
   /* private socialSigninWithToken(provider, token): Observable<any> {
    ...
    } */ //Remmed 20161126 due to linting errors
    ...
    private socialAuth(provider: string, isSignUp: boolean, spec: any = null, email: string = null) 
    {
        ...
        if (this.isMobile) {                
            ...
            /*let source = Observable.fromEvent(window, 'message');*/ //Remmed 20161126 due to linting errors
